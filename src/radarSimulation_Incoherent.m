function [radarData, radarData_dB, PD_approx, object_Pr_dB, X, Y, seaClutter, turbineReturns, radarNoise] = radarSimulation(params, turbineSegments)
    ...
    for t = 1:N_turbines
        ...
        % Incoherent summation over segments (power-based)
        sigma_total = 0;
        ...
        for s = 1:N_pole
            ...
            sigma_total = sigma_total + sigma_seg;
        end
        sigma_total_array(t) = sigma_total;
    ...
    for t = 1:N_turbines
        ...
        rel_az_angle(rel_az_angle < deg2rad(-5)) = deg2rad(-90);
        rel_az_angle(rel_az_angle >  deg2rad(5)) =  deg2rad(90);
        % Azimuth gain
